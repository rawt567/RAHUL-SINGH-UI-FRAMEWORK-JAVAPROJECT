...
designationTable.getColumnModel().getColumn(0).setPreferredWidth
(20);
designationTable.getColumnModel().getColumn(1).setPreferredWidth
(20);
...
clearSearchTextFieldButton.setBounds(lm+10+100+400+4,tm+10+40+10,30,30);
...
designationPanel.setDesignations(designation);
}catch(BLException blException)
{
...
public void setDesignations(DesignationInterface designation)
{
...
JOptionPane.showMessageDialog(this,this.designation.getTitle()+"deleted");
